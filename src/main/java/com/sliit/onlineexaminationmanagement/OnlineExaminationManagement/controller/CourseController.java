...
@RestController
@RequestMapping("/api/v1/courses") // 👈 Fixed: Added /v1 to match your Postman requests
@CrossOrigin(origins = "*")
public class CourseController {
    ...
    public ResponseEntity<Subject> addSubjectToCourse(@PathVariable Long id, @RequestBody Subject subject) {
